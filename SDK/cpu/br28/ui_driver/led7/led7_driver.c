...
LED7_PLATFORM_DATA_BEGIN(led7_test_data) = {
    ...
    .pin_cfg.pin7.pin[1] = IO_PORTA_01,
    .pin_cfg.pin7.pin[2] = IO_PORTA_02,
    .pin_cfg.pin7.pin[3] = IO_PORTA_03,
    .pin_cfg.pin7.pin[4] = IO_PORTA_04,
    .pin_cfg.pin7.pin[5] = IO_PORTA_05,
    .pin_cfg.pin7.pin[6] = IO_PORTA_06,
...
#define LED7_RTC_DISPLAY_TEST 		0
#define LED7_ICON_DISPLAY_TEST 		0
#define LED7_ICON_FLASH_TEST 		0
#define LED7_SHOW_NUMBER_TEST 		1
...
void led7_test()
{
    ...
    led7_show_RTC_time(Hour, Min);
#endif /* #if LED7_RTC_DISPLAY_TEST */

#if LED7_ICON_DISPLAY_TEST
    led7_show_icon(LED7_PLAY);
    led7_show_icon(LED7_PAUSE);
    led7_show_icon(LED7_USB); //USB
    led7_show_icon(LED7_SD); //SD
    led7_show_icon(LED7_2POINT); //
    led7_show_icon(LED7_FM);
    led7_show_icon(LED7_DOT); //
    led7_show_icon(LED7_MP3);
    led7_show_icon(LED7_REPEAT); //
    led7_show_icon(LED7_CHARGE); //
    led7_show_icon(LED7_BT); //
    led7_show_icon(LED7_AUX); //
    led7_show_icon(LED7_WMA); //
#endif /* #if LED7_ICON_DISPLAY_TEST */

#if LED7_ICON_FLASH_TEST
    led7_flash_icon(LED7_PLAY);
    led7_flash_icon(LED7_PAUSE);
    led7_flash_icon(LED7_USB);
    led7_flash_icon(LED7_SD);
    led7_flash_icon(LED7_2POINT);
    led7_flash_icon(LED7_FM);
    led7_flash_icon(LED7_DOT);
    led7_flash_icon(LED7_MP3);
    led7_flash_icon(LED7_REPEAT);
    led7_flash_icon(LED7_CHARGE);
    led7_flash_icon(LED7_BT);
    led7_flash_icon(LED7_AUX);
    ...
    static u8 cnt = 0;
    if (!(cnt % 5)) {
        led7_show_number(123); //高位显示0
    } else {
        led7_show_number2(123); //高位不显示0
    }
    if (cnt == 0) {
        led7_setX(0);
    }
    led7_show_number_add(cnt++);
#endif

#if LED7_SHOW_STRING_TEST
    static u8 cnt = '0';
    if (cnt < ('z' + 1)) {
        led7_show_char(cnt++); //显示数字
    } else {
        cnt = '0';
    }
    ...
    static u8 index = 0;
    led7_show_string_menu(index++);
    if (index > ARRAY_SIZE(menu_string_table)) {
        index = 0;
    }

    led7_show_music_play_time(index++);
    led7_show_volume(index++);
    if (index > 99) {
        index = 0;
    }
    led7_show_fm_station(index++);
#endif
}
