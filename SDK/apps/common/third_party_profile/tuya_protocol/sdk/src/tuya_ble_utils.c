...
#pragma bss_seg(".tuya_ble_utils.data.bss")
#pragma data_seg(".tuya_ble_utils.data")
#pragma const_seg(".tuya_ble_utils.text.const")
#pragma code_seg(".tuya_ble_utils.text")
#endif
/**
