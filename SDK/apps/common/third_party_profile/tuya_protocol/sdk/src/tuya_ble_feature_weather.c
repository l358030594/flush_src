...
#pragma bss_seg(".tuya_ble_feature_weather.data.bss")
#pragma data_seg(".tuya_ble_feature_weather.data")
#pragma const_seg(".tuya_ble_feature_weather.text.const")
#pragma code_seg(".tuya_ble_feature_weather.text")
#endif
/**
