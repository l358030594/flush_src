...
#pragma bss_seg(".tuya_ble_mutli_tsf_protocol.data.bss")
#pragma data_seg(".tuya_ble_mutli_tsf_protocol.data")
#pragma const_seg(".tuya_ble_mutli_tsf_protocol.text.const")
#pragma code_seg(".tuya_ble_mutli_tsf_protocol.text")
#endif
/**
