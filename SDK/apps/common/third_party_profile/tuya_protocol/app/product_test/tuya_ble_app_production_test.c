...
#pragma bss_seg(".tuya_ble_app_production_test.data.bss")
#pragma data_seg(".tuya_ble_app_production_test.data")
#pragma const_seg(".tuya_ble_app_production_test.text.const")
#pragma code_seg(".tuya_ble_app_production_test.text")
#endif
/**
