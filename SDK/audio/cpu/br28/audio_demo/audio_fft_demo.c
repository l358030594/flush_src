...
#pragma bss_seg(".audio_fft_demo.data.bss")
#pragma data_seg(".audio_fft_demo.data")
#pragma const_seg(".audio_fft_demo.text.const")
#pragma code_seg(".audio_fft_demo.text")
#endif
/*
 ****************************************************************************
 *							Audio FFT Demo
