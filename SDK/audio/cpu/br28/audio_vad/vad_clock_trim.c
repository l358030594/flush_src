...
#pragma bss_seg(".vad_clock_trim.data.bss")
#pragma data_seg(".vad_clock_trim.data")
#pragma const_seg(".vad_clock_trim.text.const")
#pragma code_seg(".vad_clock_trim.text")
#endif
/*****************************************************************
