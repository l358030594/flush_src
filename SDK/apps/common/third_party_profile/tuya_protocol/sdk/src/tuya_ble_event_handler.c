...
#pragma bss_seg(".tuya_ble_event_handler.data.bss")
#pragma data_seg(".tuya_ble_event_handler.data")
#pragma const_seg(".tuya_ble_event_handler.text.const")
#pragma code_seg(".tuya_ble_event_handler.text")
#endif
/**
...
void tuya_ble_handle_uart_cmd_evt(tuya_ble_evt_param_t *evt)
{
    ...
    if (evt->uart_cmd_data.data_len > 0) {
        uint8_t sum = tuya_ble_check_sum(evt->uart_cmd_data.p_data, evt->uart_cmd_data.data_len - 1);
