...
#pragma bss_seg(".tuya_ble_queue.data.bss")
#pragma data_seg(".tuya_ble_queue.data")
#pragma const_seg(".tuya_ble_queue.text.const")
#pragma code_seg(".tuya_ble_queue.text")
#endif
/**
