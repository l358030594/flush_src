...
#define DEFAULT_FB_GAIN				3
    ...
    ANC_BOARD_PARAM->anc_data_l = (void *)ICSD_ANC_DATA;
    ANC_BOARD_PARAM->anc_data_r = (void *)ICSD_ANC_DATA;
    ANC_BOARD_PARAM->anc_db = (void *)ANC_s8_DATA;
    ANC_BOARD_PARAM->anc_double_data_l = (void *)ICSD_ANC_DOUBLE_DATA;
    ANC_BOARD_PARAM->anc_double_data_r = (void *)ICSD_ANC_DOUBLE_DATA;
...
void icsd_anc_htarget_data_end(u8 result)
{
    ...
    */
    ...
    switch (result) {
    case 1:
        if ((TOOL_DATA->anc_combination == DFF_TFB) || (TOOL_DATA->anc_combination == DFF_DFB)) {
...
void icsd_anc_htarget_data_send()
{
    ...
    if (HEADSET_MODE) {
        ...
        if ((TOOL_DATA->anc_combination == TFF_TFB) || (TOOL_DATA->anc_combination == TFF_DFB)) {
            printf(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>ICSD_ANC_SZ_OUT_EN\n");
            icsd_anc_sz_out(TOOL_DATA->data_out1);
            icsd_anc_pz_out(TOOL_DATA->data_out2);
        }
    }
    extern void icsd_anc_sz_aeq();
    icsd_anc_sz_aeq();
#endif
