...
#pragma bss_seg(".app_protocol_mma.data.bss")
#pragma data_seg(".app_protocol_mma.data")
#pragma const_seg(".app_protocol_mma.text.const")
#pragma code_seg(".app_protocol_mma.text")
#endif
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
