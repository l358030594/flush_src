...
#pragma bss_seg(".inv_imu_transport.data.bss")
#pragma data_seg(".inv_imu_transport.data")
#pragma const_seg(".inv_imu_transport.text.const")
#pragma code_seg(".inv_imu_transport.text")
#endif
/*
