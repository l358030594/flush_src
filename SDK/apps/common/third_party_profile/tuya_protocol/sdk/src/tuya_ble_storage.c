...
#pragma bss_seg(".tuya_ble_storage.data.bss")
#pragma data_seg(".tuya_ble_storage.data")
#pragma const_seg(".tuya_ble_storage.text.const")
#pragma code_seg(".tuya_ble_storage.text")
#endif
/**
