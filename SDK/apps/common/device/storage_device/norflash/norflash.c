...
#define spi_cs_init()               gpio_set_mode(IO_PORT_SPILT(_norflash.spi_cs_io), PORT_OUTPUT_HIGH)
#define spi_cs_uninit()             gpio_set_mode(IO_PORT_SPILT(_norflash.spi_cs_io), PORT_HIGHZ)
#define spi_cs_h()                  gpio_set_mode(IO_PORT_SPILT(_norflash.spi_cs_io), PORT_OUTPUT_HIGH)
#define spi_cs_l()                  gpio_set_mode(IO_PORT_SPILT(_norflash.spi_cs_io), PORT_OUTPUT_LOW)
