...
#pragma bss_seg(".tuya_ble_event.data.bss")
#pragma data_seg(".tuya_ble_event.data")
#pragma const_seg(".tuya_ble_event.text.const")
#pragma code_seg(".tuya_ble_event.text")
#endif
/**
