...
#pragma bss_seg(".tuya_ble_unix_time.data.bss")
#pragma data_seg(".tuya_ble_unix_time.data")
#pragma const_seg(".tuya_ble_unix_time.text.const")
#pragma code_seg(".tuya_ble_unix_time.text")
#endif
/**
