...
#pragma bss_seg(".tuya_ble_event_handler_weak.data.bss")
#pragma data_seg(".tuya_ble_event_handler_weak.data")
#pragma const_seg(".tuya_ble_event_handler_weak.text.const")
#pragma code_seg(".tuya_ble_event_handler_weak.text")
#endif
/**
