...
#pragma bss_seg(".tuya_ble_gatt_send_queue.data.bss")
#pragma data_seg(".tuya_ble_gatt_send_queue.data")
#pragma const_seg(".tuya_ble_gatt_send_queue.text.const")
#pragma code_seg(".tuya_ble_gatt_send_queue.text")
#endif
/**
