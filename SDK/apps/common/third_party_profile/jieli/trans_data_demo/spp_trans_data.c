...
#pragma bss_seg(".spp_trans_data.data.bss")
#pragma data_seg(".spp_trans_data.data")
#pragma const_seg(".spp_trans_data.text.const")
#pragma code_seg(".spp_trans_data.text")
#endif
