...
#pragma bss_seg(".tuya_ble_app_uart_common_handler.data.bss")
#pragma data_seg(".tuya_ble_app_uart_common_handler.data")
#pragma const_seg(".tuya_ble_app_uart_common_handler.text.const")
#pragma code_seg(".tuya_ble_app_uart_common_handler.text")
#endif
/**
