...
#pragma bss_seg(".imuSensor_manage.data.bss")
#pragma data_seg(".imuSensor_manage.data")
#pragma const_seg(".imuSensor_manage.text.const")
#pragma code_seg(".imuSensor_manage.text")
#endif
