...
typedef struct {
    ...
    */
    ...
    // 获取设备名字
    bool (* get_device_name)(char *device_name);
    // 挂断电话
    bool (* hfp_call_hangup)(void);
    // 获取电话号码
    int (* get_call_phone_number)(char *number_list);
    // 获取本地唤醒默认开关状态
    bool (* get_wakeup_enable_default)(void);
