...
#pragma bss_seg(".app_protocol_ota.data.bss")
#pragma data_seg(".app_protocol_ota.data")
#pragma const_seg(".app_protocol_ota.text.const")
#pragma code_seg(".app_protocol_ota.text")
#endif
